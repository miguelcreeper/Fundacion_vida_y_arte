    ...
    <div class="card-header">
     <div class="col-lg-12">
        ...
        <div class="box box-primary">
            ...
            <p>
                <form action="{{ route("pdf_mensualidad") }}" >
                    <button class="btn btn-secondary buttons-csv buttons-html5" tabindex="0" aria-controls="tableExport"><span>PDF</span></button>
                </form>
                    ...
                    <body>
                        @foreach($datas as $mensualidad)
                            <tr>
                                ...
                                {{-- @foreach ($datas->matriculan as $item)
                                <td>{{$item->id}}</td>
                                @endforeach --}}
